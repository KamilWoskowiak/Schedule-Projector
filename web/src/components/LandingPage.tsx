      ...
      <main className="flex-grow flex items-center justify-center p-8">
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="flex flex-col justify-center space-y-8">
            <h1 className="text-6xl font-bold mb-6 text-primary leading-tight">Optimize Your College Journey</h1>
            <p className="text-2xl mb-8">
              Welcome to the ultimate college scheduling app! Our platform helps you create an optimized course schedule
